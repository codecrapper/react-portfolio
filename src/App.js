      ...
      <div className="content-container">
        ...
        <section className="my-info">
          <div className="container description-container">
            <p className="my-description">Hello, I am JohnjohnJohn. I am free lance <span className="fancy">developer.</span> Living in South Pole Antarctica, currently working for <span className="fancy">twitch.</span></p>
          </div>
