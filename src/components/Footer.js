            ...
            <footer id="contact" className="footer-navbar">
                ...
                <div className="footer-container">
                    <ul className="social-list">
                        <li className="social-list__item"><a href="https://github.com/" target="_blank" rel="noopener noreferrer">GitHub</a></li>
                        <li className="social-list__item"><a href="https://twitter.com/" target="_blank" rel="noopener noreferrer">Twitter</a></li>
                        <li className="social-list__item"><a href="https://au.linkedin.com/" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
